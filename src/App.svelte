...
<p>
  ...
  <a href="https://github.com/janosh/svelte-masonry">GitHub</a>
</p>
<p>
  Balanced columns can be achieved even with this simple version if the items are allowed
  to stretch to the column height.
</p>
